...
namespace Gcs
{
    public class Gcs
    {
        ...
        public string EyesString { get { return GcsGroups.Eyes[Category[0]]; } }
        public string VerbalString { get { return GcsGroups.Verbal[Category[1]]; } }
        public string MotorString { get { return GcsGroups.Motor[Category[2]]; } }
